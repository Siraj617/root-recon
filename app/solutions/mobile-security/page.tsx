                ...
                <div className="container px-4 mx-auto">
                    <div className="max-w-4xl mx-auto text-center">
                        ...
                        <h1 className="text-4xl md:text-5xl lg:text-6xl font-extrabold text-black mb-6 leading-tight">
                            Secure Your Mobile App Against <span className="text-red-600">Reverse Engineering & Runtime Attacks</span>
                        </h1>
                ...
                <div className="container px-4 mx-auto">
                    ...
                    <div className="bg-white border border-slate-200 rounded-2xl shadow-lg p-8 md:p-10 max-w-6xl mx-auto">
                        <div className="grid md:grid-cols-3 gap-8">
                            {[
                                { icon: Database, title: "Insecure Storage", desc: "Finding sensitive data in logs, plist, shared prefs, and local DBs.", color: "text-red-600", bg: "bg-red-100" },
                                { icon: Network, title: "Insecure Comms", desc: "Testing SSL pinning, certificate validation, and traffic encryption.", color: "text-red-600", bg: "bg-red-100" },
                                ...
                                { icon: Code, title: "Code Quality", desc: "Analyzing source code for hardcoded secrets and logic errors.", color: "text-red-600", bg: "bg-red-100" },
                                { icon: Bug, title: "Runtime Attacks", desc: "Using Frida to hook functions and modify app behavior on the fly.", color: "text-red-600", bg: "bg-red-100" },
                                { icon: Eye, title: "Privacy Leaks", desc: "Detecting excessive permissions and data sharing with third parties.", color: "text-red-600", bg: "bg-red-100" },
                            ].map((feature, index) => (
