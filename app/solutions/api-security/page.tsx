...
const processSteps = [
    ...
    { icon: Key, title: "Auth Analysis", desc: "Test JWT/OAuth", color: "#ef4444" },
    { icon: Lock, title: "Authorization", desc: "Test BOLA/BFLA", color: "#b91c1c" },
    { icon: Code, title: "Injection", desc: "SQLi/Command Inj", color: "#991b1b" },
    { icon: Zap, title: "Logic Testing", desc: "Business rules", color: "#7f1d1d" },
];
                ...
                <div className="container px-4 mx-auto">
                    ...
                    <div className="bg-white border border-slate-200 rounded-2xl shadow-lg p-8 md:p-10 max-w-6xl mx-auto">
                        <div className="grid md:grid-cols-3 gap-8">
                            {[
                                { icon: Key, title: "BOLA (IDOR)", desc: "Testing for unauthorized access to other users' resources.", color: "text-red-600", bg: "bg-red-100" },
                                { icon: Lock, title: "Broken Auth", desc: "Identifying weaknesses in JWT, OAuth, and API keys.", color: "text-red-600", bg: "bg-red-100" },
                                ...
                                { icon: Eye, title: "Data Exposure", desc: "Ensuring APIs don't leak excessive sensitive data.", color: "text-red-600", bg: "bg-red-100" },
                                { icon: Code, title: "Injection", desc: "SQLi, Command Injection, and NoSQL injection in APIs.", color: "text-red-600", bg: "bg-red-100" },
                            ].map((feature, index) => (
