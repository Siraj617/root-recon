                ...
                <div className="container px-4 mx-auto">
                    ...
                    <div className="bg-white border border-slate-200 rounded-2xl shadow-lg p-8 md:p-10 max-w-6xl mx-auto">
                        <div className="grid md:grid-cols-3 gap-8">
                            {[
                                { icon: Key, title: "IAM Misconfigs", desc: "Overly permissive roles and privilege escalation paths.", color: "text-red-600", bg: "bg-red-100" },
                                { icon: Database, title: "Public Storage", desc: "Exposed S3 buckets, blobs, and unencrypted data.", color: "text-red-600", bg: "bg-red-100" },
                                ...
                                { icon: Settings, title: "K8s Security", desc: "Misconfigured clusters, pods running as root, and secrets exposure.", color: "text-red-600", bg: "bg-red-100" },
                                ...
                                { icon: Code, title: "Secrets in Code", desc: "Hardcoded API keys and credentials in Lambda/Functions.", color: "text-red-600", bg: "bg-red-100" },
                            ].map((feature, index) => (
