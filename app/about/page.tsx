...
const stats = [
    ...
    { value: "250+", label: "Enterprise & Startup Clients", icon: Briefcase },
    { value: "10,000+", label: "Verified Vulnerabilities Found", icon: Target },
    { value: "99%", label: "Client Satisfaction", icon: Star },
];

const values = [
    { icon: Target, title: "Attacker Mindset", desc: "We think like adversaries to uncover vulnerabilities that scanners and traditional testing miss." },
    { icon: Shield, title: "Defense-Grade Reporting", desc: "Clear, actionable reports designed for developers, security teams, and leadership." },
    { icon: Users, title: "Collaborative Approach", desc: "We work as an extension of your team, with transparent communication and continuous support." },
    { icon: Award, title: "Proven Expertise", desc: "Our researchers have discovered critical bugs in Fortune 500 companies and high-traffic platforms worldwide." },
];

const certifications = ["CREST Certified", "OSCP", "OSCE", "OSWE", "AWS Security", "Azure Security"];

const whyChooseUs = [
    { icon: Zap, title: "Fast Turnaround", desc: "Comprehensive reports delivered within 5–7 business days. Critical vulnerabilities are reported immediately, not at the end." },
    { icon: Lock, title: "Zero False Positives", desc: "Every finding is manually verified by experienced security researchers. No noise. No guesswork. Only real, exploitable issues." },
    { icon: Eye, title: "Deep Manual Testing", desc: "We don't rely on tools alone. Our experts spend 40+ hours manually testing your application to uncover complex logic flaws and chained attacks." },
    { icon: FileSearch, title: "Developer-Friendly Remediation", desc: "Clear, step-by-step fix guidance with code-level examples. Your developers know exactly what to fix and how." },
];

const approach = [
    { step: "01", title: "Discovery", desc: "We start by understanding your application architecture, tech stack, business logic, and high-value assets — allowing us to focus on what actually matters." },
    { step: "02", title: "Reconnaissance", desc: "We map the full attack surface by identifying entry points, enumerating roles and permissions, and analyzing workflows and edge cases — just like a real attacker would." },
    { step: "03", title: "Exploitation", desc: "We don't stop at detection. We exploit vulnerabilities, chain multiple issues, and demonstrate real-world impact to show how bad things can really get." },
    { step: "04", title: "Reporting", desc: "Risk-ranked vulnerabilities, clear Proof of Concepts (PoCs), business impact analysis, and actionable remediation steps — delivered in hours, not weeks." },
];
            ...
            <section className="py-24 bg-gradient-to-b from-white to-slate-50">
                <div className="container px-4 mx-auto">
                    <SectionHeading
                        ...
                        subtitle="Security that goes beyond compliance. Most breaches don't happen because scanners failed — they happen because logic was broken. At RootRecon, we focus on what attackers actually do."
                    />
                ...
                <div className="container px-4 mx-auto">
                    ...
                    <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
                        {approach.map((item, index) => (
                            <div key={index} className="bg-white rounded-2xl p-8 border border-slate-200 shadow-md hover:border-red-500 transition-colors">
                                <div className="text-5xl font-extrabold text-red-100 mb-4">{item.step}</div>
