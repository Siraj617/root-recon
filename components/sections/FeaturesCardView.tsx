    ...
    >
      ...
      <div className="hidden md:flex justify-center items-center h-[620px] relative perspective-[1600px] [transform-style:preserve-3d]">
        {careItems.map((item, index) => (
          <div
            key={index}
            className="absolute w-[265px] h-[380px] bg-black rounded-2xl p-8 shadow-2xl border border-white/10 transition-all duration-700 ease-out will-change-transform flex flex-col hover:scale-105 hover:border-slate-500/50 hover:shadow-red-500/10"
            style={{
